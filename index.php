...
<div class="site-wrap">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-6 col-xl-2">
                    <h1 class="mb-0 site-logo"><a href="index.html" class="h2 mb-0"><span style="color:blue">Blue</span><span style="color:white">Bank</span><span class="text-primary">.</span> </a></h1>
                </div>
                    ...
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        ...
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <?php if(isset($_SESSION["full_name"])){?>
                                <li class="has-children">
                                    <a href="#about-section" class="nav-link"><?php echo $_SESSION["full_name"]; ?></a>
                                    <ul class="dropdown">
                                        <li><a href="userinfo.php?userid=<?php echo $_SESSION["id"]; ?>" class="nav-link">Account information</a></li>
                                        <li><a href="#pricing-section" class="nav-link">transaction</a></li>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(https://pbs.twimg.com/media/F6OLvmWWcAAhxBV?format=jpg&name=large);" data-aos="fade" id="home-section">
            ...
            <div class="row">
                <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
                    <figure class="circle-bg">
                        <img src="assets/images/about_2.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
                    </figure>
                </div>
    ...
    <div class="site-section cta-big-image" id="about-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
                    <figure class="circle-bg">
                        <img src="assets/images/hero_1.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
                    </figure>
                </div>
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="">
                    <div class="team-member">
                        <figure>
                            ...
                            <img src="https://media.licdn.com/dms/image/D4E03AQFcAwd1VvvRAg/profile-displayphoto-shrink_400_400/0/1692392951566?e=1700697600&v=beta&t=5GFrw1-ikUh9jYRTKUUuQ6Gqn_x_iB8sMbL0CZCmeH0" alt="Image" class="img-fluid">
                        </figure>
                        <div class="p-3">
                ...
                <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="team-member">
                        <figure>
                            ...
                            <img src="https://media.licdn.com/dms/image/D4E03AQFMvNPLxpq7zQ/profile-displayphoto-shrink_800_800/0/1689056329050?e=1700697600&v=beta&t=9FwE9odbg_tmY_rvxy3boeMQJx2gR8ZV45fkWU48tlk" alt="Image" class="img-fluid">
                        </figure>
                        <div class="p-3">
                            <h3>Dave Simpson</h3>
                ...
                <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="team-member">
                        <figure>
                            ...
                            <img src="https://media.licdn.com/dms/image/D4D35AQHC9AvgYOYU9w/profile-framedphoto-shrink_800_800/0/1693688109657?e=1695733200&v=beta&t=NJEDkjAw-uFjrbXIc6SewPP0fFQDz6Gh0MZx5yTfmMA" alt="Image" class="img-fluid">
                        </figure>
                        <div class="p-3">
                            <h3>Kyla Stewart</h3>
                            <span class="position">Accountant</span>
        ...
        <div class="container">
            ...
            <div id="posts" class="row no-gutter">
                <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
                    <a href="assets/images/img_1.jpg" class="item-wrap fancybox">
        ...
        <div class="container">
            ...
            <div class="row align-items-stretch">
                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="unit-4">
                        <div class="unit-4-icon">
                            <img src="assets/images/flaticon-svg/svg/002-rich.svg" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
                        </div>
                        <div>
                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="">
                    <div class="unit-4">
                        <div class="unit-4-icon">
                            <img src="assets/images/flaticon-svg/svg/003-notes.svg" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
                        </div>
                        <div>
                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="unit-4">
                        <div class="unit-4-icon">
                            <img src="assets/images/flaticon-svg/svg/005-megaphone.svg" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
                        </div>
                        <div>
